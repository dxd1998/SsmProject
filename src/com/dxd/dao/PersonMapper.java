...
public interface PersonMapper {
	 ...
	 * @return
	 */
	public List<Person> getPersonCount(Map<String,Object> map);
	/**
	 * 删除指定员工
	 * @param pId
	 * @return
	 ...
	 * @return
	 */
	public int updatePerson_Role(@Param("pId")Integer pId,@Param("rId")Integer rId);
	/**
	 * 修改员工部门
	 * @param pId
	 * @param dId
	 * @return
	 */
	public int updatePerson_Department(@Param("pId")Integer pId,@Param("dId")Integer dId);
	/**
	 * 绑定指定员工地址
	 * @param pId
	 * @param aId
	 * @return
	 */
	public int addPerson_Address(@Param("pId")Integer pId,@Param("aId")Integer aId);
	/**
	 * 判断该员工用户名是否存在
	 * @param pLoginName
	 * @return
